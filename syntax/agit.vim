...
syn cluster agitLogFields contains=agitRef,agitDate,agitAuthor,agitHash
syn cluster agitRefs contains=agitHead,agitBranch,agitRemote,agitTag

syn match agitTree /^[|/\\* ]\+/ nextgroup=agitLog
syn match agitLog /.*/ contained contains=@agitLogFields

syn region agitRef start="(" end=")" end="\.\.\." contained contains=@agitRefs keepend
...
syn match agitHash  /\[\x\+]/ contained conceal
